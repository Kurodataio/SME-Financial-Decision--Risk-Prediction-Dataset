...
- The size of the dataset is 10000 rows and 33 columns
...
git clone https://github.com/Kurodataio/SME-Financial-Decision--Risk-Prediction-Dataset.git

# Navigate to the project folder
cd SME-Financial-Decision--Risk-Prediction-Dataset.git
...
1. Open the main notebook (`sme-fd-risk-prediction.ipynb`)  
